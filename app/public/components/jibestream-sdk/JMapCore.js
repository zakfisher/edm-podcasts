...
(function (JMap) {
    var Building = (function () {
        ...
        Building.prototype.init = function () {
            ...
            this.tools.id = "map-tools";
            this.tools.x = 100;
            this.tools.y = 100;
            this.overlay.appendChild(this.tools);
        ...
        Building.prototype.fromYahToDest = function (useElevator) {
            ...
            this.pathData = this.pathProcessor.compile(JMap.storage.maps.model.findWay(this.destYah, this.targetDestination, useElevator), this.endDestination.name, 14);
       ...
       Building.prototype.pathAnimationComplete = function (){
        ...
        Building.prototype.onBuildingData = function () {
            ...
            for (var i = 0, n = maps.length; i < n; i++) {
                ...
                fl.description = maps[i].description;
                fl.sequence = maps[i].floorSequence;
                this.floors[maps[i].mapId] = fl;
        ...
        Building.prototype.swipeFloor = function (event, direction, distance, duration, fingerCount, fingerData) {
            ...
            for(var i =0; i < maps.length; i++){
                if(!min || min > maps[i].floorSequence)min = maps[i].floorSequence;
                if(!max || max < maps[i].floorSequence)max = maps[i].floorSequence;
            }
            ...
            for(i =0; i < maps.length; i++){
                if(maps[i].floorSequence == this.floorlevelCurrent){
                    mapId = maps[i].mapId;
    ...
    JMap.PathProcessor = PathProcessor;
      ...
      var Floor = (function () {
        ...
        Floor.prototype.hideTooltip = function() {
            ...
            //TweenLite.to($(this.nameToolTip), 0, {alpha:0});
        };
        ...
        Floor.prototype.showBubble = function (bubbleText) {//Shows bubble at the last point of the path
            ...
            var b = "<div id='bubbleLeft' class='item mark destination' data-show-at-zoom='0' data-position='" + (lastP.x * this.scaleOffset) + "," + (lastP.y * this.scaleOffset) + "' data-allow-scale='false' data-allow-drag='false'><img src='" + (JMap.getLabelById("searchDestination").filePath) + "' /></div>";
